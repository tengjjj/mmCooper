...
from multistage.tools import train_utils
from multistage.tools import multi_gpu_utils
...
def main():
    ...
    for epoch in range(init_epoch, max(epoches, init_epoch)):
        ...
        if hypes['name']=='point_pillar_multi_fusion':
        ...
        for i, batch_data in enumerate(train_loader):
            ...
            if not opt.half:
                if epoch >= hypes.train_params.transformer_epoch:
                    ...
                    model.module.fuse.transformer_flag = True
                    model.module.transformer_flag = True
                    criterion.transformer_flag = True
                if hypes['name']=='point_pillar_multi_fusion':
                     ouput_dict = model(batch_data['ego'], tau)
                else:
