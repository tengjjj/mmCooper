...
def add_noise_data_dict(data_dict, noise_setting, train_flag, seed_flag):
    ...
    if noise_setting:
        for cav_id, cav_content in data_dict.items():
            ...
            cav_content['params']['lidar_pose'] = cav_content['params']['lidar_pose'] + \
                                                    generate_noise(
                                                        noise_setting['xyz_std'],
                                                        noise_setting['ryp_std'],
                                                        train_flag,
                                                        seed_flag
                                                    )
    else:
...
def generate_noise(pos_std, rot_std, train_flag, seed_flag, pos_mean=0, rot_mean=0):
