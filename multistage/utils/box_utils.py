...
import multistage.utils.common_utils as common_utils
from multistage.utils.transformation_utils import x1_to_x2, x_to_world
...
def get_mask_for_boxes_within_range_torch(boxes):
    ...
    """
    from multistage.data_utils.datasets import GT_RANGE
...
def project_world_objects_dairv2x(object_list,
    ...
    for object_content in object_list:        
        ...
        corners_world_homo = np.pad(corners_world, ((0,0), (0,1)), constant_values=1)
