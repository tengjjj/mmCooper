...
from multistage.models.sub_modules.fuse_utils import regroup
...
from multistage.models.sub_modules.f_cooper_fuse import SpatialFusion
...
class PointPillarFCooper(nn.Module):
    ...
    def forward(self, data_dict):
        ...
        output_dict = {'psm': psm,
                       'rm': rm,
                       'total_comm_rate': torch.tensor(0)
                       }
