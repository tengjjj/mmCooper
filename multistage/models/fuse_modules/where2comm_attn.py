...
from multistage.models.comm_modules.where2comm import Communication
    ...
    def forward(self, x, rm, record_len, pairwise_t_matrix, backbone=None, heads=None):
        ...
        if self.multi_scale:
            ...
            for i in range(self.num_levels):
                ...
                # for example [[2, 64, 100, 252], [2, 64, 100, 252],[2, 64, 100, 252],[2, 64, 100, 252],...]
                ...
                x_fuse = torch.stack(x_fuse)  # 6，64，100，252
