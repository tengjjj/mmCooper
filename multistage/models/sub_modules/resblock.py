...
class ResNetModified(nn.Module):
    ...
    def _forward_impl(self, x: Tensor, return_interm: bool = True, index=-1):
    ...
    def forward(self, x: Tensor, return_interm=True, index=-1):
        return self._forward_impl(x, return_interm, index)
